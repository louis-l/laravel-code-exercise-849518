                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4">
                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                            Showing
                            <span class="font-semibold text-gray-900 dark:text-white">{{ employees.from }}-{{ employees.to }}</span>
                            of
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <Link
                                ...
                                :class="!employees.prev_page_url ? 'cursor-not-allowed pointer-events-none opacity-50' : null"
                            ...
                            <Link
                                ...
                                :class="!employees.next_page_url ? 'cursor-not-allowed pointer-events-none opacity-50' : null"
                                class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                            >
                                Next
